...
MCLcore.mountNotes = {
	...
	[275656] = "Reward from the achievement \"Treasures of the Coiled Isle.\" Discover all 22 hidden treasures across the Coiled Isle - every location is pinned on the world map by the Guide, and pins disappear as you loot them.\n\nSeven of them need extra steps first (Amani Privateer's Cache, Sunken Diver's Chest, Profane Ritual Spoils, Lost Spirit, Vul'zahn's Smuggled Treasure, Grave of Someone Forgotten and Brine-Crusted Chest) - hover their map pin for the full unlock chain, or left-click it for a step-by-step tracker that waypoints each stage and ticks them off as you go.",
	...
	[275659] = "Drops from Ral'kala, the Nightmare-only Prey boss on the Coiled Isle. Introduced by the hunt \"Prey: A Ghostly Nightmare.\"\n\n1. Unlock Preyhunter's Journey Rank 1 for Season 2.\n2. Toggle Nightmare mode by speaking to the Image of Astalor Bloodsworn at Tokka's Landing {{m:2512,58.2,48.7}}, or take a Nightmare Prey hunt in the zone.\n3. Burn Ossified Relics at a Haunted Brazier (blue brazier icons on the world map) until the bar fills to summon him. This is a public event, so any Nightmare-flagged player can contribute.",
	...
	[273838] = "Reward from a Zul'jarra's Forces Renown questline. At Renown 10, speak to Du'gal in the Vaults of Atal'Utek {{m:2509,50.5,63.9}} to start it.\n\nSix time-gated quests, beginning with \"Ancestral Gems\" and ending with \"The Innocent Essence.\"",
