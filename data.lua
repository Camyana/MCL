...
core.mountList[18] = {
	...
	categories = {
		...
		Zone = {
			name = "Zone",
			mounts = {192601, 198873, 198871, 192775, 201454, 192800, 204382, 192785, 192790, 192772, 191838, 205203, 205197, 210774, 210412},
		},
		TradingPost = {
			name = "Trading Post",
		...
		Vendor = {
			name = "Vendor",
			mounts = {206673, 206680, 206676, 206678, 206674, 206679, 206675, 210775, 210769, 210058, 210057, 209947, 209950}
		},
		Raid = {
			name = "Raid",
			mounts = {}
