...
core.mountList[18] = {
	...
	categories = {
		...
		Achievement = {
			name = "Achievement",
			mounts = {192806, 192791, 192784, 205205, 208152, 210060, 209060, 192774, 210142, "m1614", 198822, 192792, 192788, 211862, 192765, 192774, "m1733"},
		},
		Treasures = {
			name = "Treasures",
		...
		TradingPost = {
			name = "Trading Post",
			mounts = {190231, 190168, 190539, 190767, 190613, 206156, 137576, 208598, 211084, 211074, 210919, 212227, 212630, 212920},
		},
		Secret = {
			name = "Secret",
			mounts = {192786}
