            ...
            for ii,v in ipairs(core.sectionNames) do
                ...
                elseif v.name == core.sections[i].name then
                    if v.name == "Pinned" then
                        ...
                        category.info:SetText(L["Ctrl + Right Click to pin uncollected mounts"])
                    end                   
...
function MCL_functions:UpdateCollection()
    ...
    for k, v in pairs(core.stats) do
        ...
        if section_name == L["Unobtainable"] then
...
function MCL_functions:AddonSettings()
    ...
    local options = {
        type = "group",
        name = L["Mount Collection Log Settings"],
        order = 1,
        args = {
            headerone = {             
                order = 1,
                name = L["Main Window Options"],
                type = "header",
                width = "full",
            },            
            mainWindow = {             
                order = 2,
                name = L["Main Window Opacity"],
                desc = L["Changes the opacity of the main window"],
                type = "range",
                width = "normal",
                min = 0,
                max = 1,
            ...
            defaultOpacity = {
                order = 3,
                name = L["Reset Opacity"],
                desc = L["Reset to default opacity"],
                width = "normal",
                type = "execute",
                func = function()
            ...
            defaultTexture = {
                order = 6,
                name = L["Reset Texture"],
                desc = L["Reset to default texture"],
                width = "normal",
                type = "execute",
                func = function()
            ...
            progressColorLow = {
                order = 7,
                type = "color",
                name = L["Progress Bar (<33%)"],
                width = "normal",
                desc = L["Set the progress bar colors to be shown when the percentage collected is below 33%"],
            ...
            progressColorMedium = {
                order = 8,
                type = "color",
                name = L["Progress Bar (<66%)"],
                width = "normal",
                desc = L["Set the progress bar colors to be shown when the percentage collected is below 66%"],
            ...
            progressColorHigh = {
                order = 9,
                type = "color",
                name = L["Progress Bar (<100%)"],
                width = "normal",
                desc = L["Set the progress bar colors to be shown when the percentage collected is below 100%"],
            ...
            progressColorComplete = {
                ...
                name = L["Progress Bar (100%)"],
                width = "normal",
                desc = L["Set the progress bar colors to be shown when all mounts are collected"],
            ...
            defaultColor = {
                order = 11,
                name = L["Reset Colors"],
                desc = L["Reset to default colors"],
                width = "normal",
                type = "execute",
                func = function()
            ...
            headerthree = {             
                order = 12,
                name = L["Unobtainable Settings"],
                type = "header",
                width = "full",
            },            
            unobtainable = {             
                order = 13,
                name = L["Hide Unobtainable from overview"],
                desc = L["Hide Unobtainable mounts from the overview."],
                type = "toggle",
                width = "full",
            ...
            defaults = {
                order = 16,
                name = L["Reset Settings"],
                desc = L["Reset to default settings"],
                width = "normal",
                type = "execute",
                func = function()
